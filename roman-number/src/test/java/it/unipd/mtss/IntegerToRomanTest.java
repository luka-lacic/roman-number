...
public class IntegerToRomanTest {
    ...
    @Test
    public void testConvert_WithNumberForty_ShouldReturnRomanXL() {
        assertEquals("XL", IntegerToRoman.convert(40));
    }

    @Test
    public void testConvert_WithNumberFifty_ShouldReturnRomanL() {
    ...
    @Test
    public void testConvert_WithNumberFourHundred_ShouldReturnRomanCD() {
        assertEquals("CD", IntegerToRoman.convert(400));
    }

    @Test
    public void testConvert_WithNumberFiveHundred_ShouldReturnRomanD() {
